...
export function getSupabaseAuthConnectSource() {
  ...
  try {
    ...
    const hostname = url.hostname.toLowerCase();
    return url.protocol === "http:" && (hostname === "localhost" || hostname === "127.0.0.1" || hostname === "e2e.test")
      ? ` ${url.origin}`
      : "";
  } catch {
    return "";
...
const supabaseAuthConnectSource = getSupabaseAuthConnectSource();
