...
export function DecisionReport({
  propertySearch, valuation, loan, holding, location,
}: {
  propertySearch?: PropertySearchResult; valuation?: ValuationResult; loan?: LoanCalculationResult; holding?: HoldingCostResult; location?: LocationInsightResult;
}) {
