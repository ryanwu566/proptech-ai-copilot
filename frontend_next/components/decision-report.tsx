...
export function DecisionReport({
  propertySearch, valuation, loan, holding, location, riskSummary,
}: {
  propertySearch?: PropertySearchResult; valuation?: ValuationResult; loan?: LoanCalculationResult; holding?: HoldingCostResult; location?: LocationInsightResult; riskSummary?: RiskSummary;
}) {
