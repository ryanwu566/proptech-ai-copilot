...
export type AppPage = "儀表板" | "TaxOracle" | "Market Insight Lite" | "Map Insight Lite" | "Aegis-Credit Lite" | "LexProp Lite" | "歷史案件";
...
const groups: { label: string; items: { page: AppPage; label: string }[] }[] = [
  ...
  { label: "區域洞察", items: [{ page: "Market Insight Lite", label: "Market Insight" }, { page: "Map Insight Lite", label: "Map Insight" }] },
