...
import { TERRAIN_RISK_RESULT_EVENT } from "@/components/terrain-risk-analysis";
...
export function GuidedDemoRunner({ onMessage, onSave, onExport, canExport = false }: Props) {
  ...
  function publishResults(next: DemoResults) {
    ...
    if (next.terrainRisk) { window.dispatchEvent(new CustomEvent(TERRAIN_RISK_RESULT_EVENT, { detail: next.terrainRisk })); }
