  ...
  return (
    <main className={styles.page}>
      ...
      {property && resolution && <section className={styles.panel} aria-labelledby="property-heading">
        ...
        {workspace?.workspace_id === property.workspace_id && <p><a href={`/vnext/property-identity/${workspace.workspace_id}/${property.property_entity_id}`}>審閱此房產的地號、建號與待確認關係</a></p>}
