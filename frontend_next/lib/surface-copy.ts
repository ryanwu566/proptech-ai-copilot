...
const terrainZh: TerrainSurfaceCopy = {
  ...
  temporarilyUnavailable: "暫時不可用", progressTitle: "檢查進度", progressAccepted: "已接受輸入",
...
const terrainEn: TerrainSurfaceCopy = {
  ...
  temporarilyUnavailable: "Temporarily unavailable", progressTitle: "Check progress", progressAccepted: "Input accepted",
