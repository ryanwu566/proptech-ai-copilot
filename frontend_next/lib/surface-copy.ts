...
export type TerrainSurfaceCopy = {
  ...
  advanced: string; radiusSummary: string; dataCompleteness: string; checked: string; usable: string;
  limitedCount: string; unavailableCount: string; priorityFollowUp: string; actualEvidence: string;
  autoCheckAvailable: string; referenceExternal: string; temporarilyUnavailable: string;
  matchedRange: string; nearestDistance: string; limitedSourceCaveat: string;
  progressTitle: string; progressAccepted: string; progressDispatched: string; progressWaiting: string;
  progressReceived: string; progressRendering: string; progressComplete: string;
  cadastralTitle: string; cadastralSubtitle: string; cadastralReferenceOnly: string;
  cadastralPointOnly: string; cadastralLoading: string; cadastralUnavailable: string;
  cadastralNotConfigured: string; cadastralSource: string; cadastralLastChecked: string;
  cadastralLegend: string; cadastralMarkerLegend: string; cadastralRadiusLegend: string;
  cadastralManualVerification: string; cadastralWhere: string; cadastralChecked: string;
  cadastralStillNeeded: string; cadastralMapAria: string; cadastralLimitation: string;
  coordinateSource: string; coordinateSources: Record<string, string>;
};
...
const terrainZh: TerrainSurfaceCopy = {
  ...
  advanced: "進階設定", radiusSummary: "目前檢查半徑", dataCompleteness: "資料完整度", checked: "已檢查",
  usable: "可用", limitedCount: "有限", unavailableCount: "不可用", priorityFollowUp: "優先確認",
  actualEvidence: "實際災害證據", autoCheckAvailable: "可自動檢查", referenceExternal: "參考／外部確認",
  temporarilyUnavailable: "暫時不可用",
  matchedRange: "已命中風險範圍", nearestDistance: "最近距離：約 {m} m", limitedSourceCaveat: "部分官方圖資本次未完整取得，仍建議至官方圖台複核。",
  progressTitle: "檢查進度", progressAccepted: "已接受輸入",
  progressDispatched: "已送出請求", progressWaiting: "等待資料來源回應", progressReceived: "已收到回應",
  progressRendering: "正在整理證據", progressComplete: "結果已呈現",
  cadastralTitle: "地籍參考證據", cadastralSubtitle: "以本次分析座標對照位置、已檢查來源與待人工確認事項。",
  cadastralReferenceOnly: "地籍影像僅供位置參考", cadastralPointOnly: "點位參考模式",
  cadastralLoading: "地籍參考圖載入中", cadastralUnavailable: "地籍參考暫時不可用",
  cadastralNotConfigured: "未設定可用的地籍圖資服務", cadastralSource: "官方來源",
  cadastralLastChecked: "最後檢查", cadastralLegend: "圖例", cadastralMarkerLegend: "本次分析座標",
  cadastralRadiusLegend: "分析範圍（不是宗地界址）", cadastralManualVerification: "向地政事務所確認謄本、地號與鑑界資料",
  cadastralWhere: "物件在哪裡", cadastralChecked: "檢查了什麼", cadastralStillNeeded: "還需確認什麼",
  cadastralMapAria: "地籍參考證據地圖", cadastralLimitation: "系統未取得法定地籍向量，不掌握宗地多邊形，也不計算宗地交集、法定面積或地號。",
  coordinateSource: "定位來源", coordinateSources: { google_geocoding: "Google Geocoding", tgos_geocoding: "TGOS", mock: "展示定位", provided_coordinates: "使用者提供座標", unknown: "未知" },
};
...
const terrainEn: TerrainSurfaceCopy = {
  ...
  advanced: "Advanced settings", radiusSummary: "Current check radius", dataCompleteness: "Data completeness", checked: "Checked",
  usable: "Usable", limitedCount: "Limited", unavailableCount: "Unavailable", priorityFollowUp: "Priority follow-up",
  actualEvidence: "Actual hazard evidence", autoCheckAvailable: "Auto check available", referenceExternal: "Reference / external check",
  temporarilyUnavailable: "Temporarily unavailable",
  matchedRange: "Matched risk range", nearestDistance: "Nearest distance: about {m} m", limitedSourceCaveat: "Some official map layers were not fully retrieved this time; please still verify on the official map portal.",
  progressTitle: "Check progress", progressAccepted: "Input accepted",
  progressDispatched: "Request dispatched", progressWaiting: "Waiting for data sources", progressReceived: "Response received",
  progressRendering: "Rendering evidence", progressComplete: "Result rendered",
  cadastralTitle: "Cadastral reference evidence", cadastralSubtitle: "See the analyzed point, checked sources, and items that still require manual verification.",
  cadastralReferenceOnly: "Cadastral imagery is visual reference only", cadastralPointOnly: "Point-reference-only mode",
  cadastralLoading: "Loading cadastral reference", cadastralUnavailable: "Cadastral reference temporarily unavailable",
  cadastralNotConfigured: "No authorized cadastral map service is configured", cadastralSource: "Official source",
  cadastralLastChecked: "Last checked", cadastralLegend: "Map legend", cadastralMarkerLegend: "Analyzed coordinate",
  cadastralRadiusLegend: "Analysis radius (not a parcel boundary)", cadastralManualVerification: "Confirm the transcript, lot identifier, and survey with the local land office",
  cadastralWhere: "Where is the property?", cadastralChecked: "What was checked?", cadastralStillNeeded: "What still needs confirmation?",
  cadastralMapAria: "Cadastral reference evidence map", cadastralLimitation: "No authorized cadastral vector is available. The system does not know the parcel polygon or calculate parcel intersections, legal area, or lot identifiers.",
  coordinateSource: "Location source", coordinateSources: { google_geocoding: "Google Geocoding", tgos_geocoding: "TGOS", mock: "Demo geocoding", provided_coordinates: "User-provided coordinates", unknown: "Unknown" },
};
...
Object.assign(terrainJa, { advanced: "詳細設定", radiusSummary: "現在の確認半径", dataCompleteness: "データ完全性", checked: "確認済み", usable: "利用可能", limitedCount: "限定的", unavailableCount: "利用不可", priorityFollowUp: "優先確認", actualEvidence: "実際の災害根拠", autoCheckAvailable: "自動確認可能", referenceExternal: "参考／外部確認", temporarilyUnavailable: "一時利用不可", matchedRange: "リスク範囲に該当", nearestDistance: "最短距離：約 {m} m", limitedSourceCaveat: "一部の公式地図データを今回は完全に取得できませんでした。公式地図ポータルで再確認してください。", progressTitle: "確認の進行状況", progressAccepted: "入力を受け付けました", progressDispatched: "リクエストを送信しました", progressWaiting: "データソースの応答待ち", progressReceived: "応答を受信しました", progressRendering: "根拠を整理中", progressComplete: "結果を表示しました", cadastralTitle: "地籍参照エビデンス", cadastralSubtitle: "分析座標、確認済みの情報源、手動確認が必要な項目を表示します。", cadastralReferenceOnly: "地籍画像は位置参照専用", cadastralPointOnly: "点位置参照モード", cadastralLoading: "地籍参照を読み込み中", cadastralUnavailable: "地籍参照は一時利用不可", cadastralNotConfigured: "認可された地籍地図サービスは未設定", cadastralSource: "公式情報源", cadastralLastChecked: "最終確認", cadastralLegend: "地図凡例", cadastralMarkerLegend: "今回の分析座標", cadastralRadiusLegend: "分析範囲（筆界ではありません）", cadastralManualVerification: "土地事務所で謄本、地番、境界確認資料を確認", cadastralWhere: "物件はどこですか？", cadastralChecked: "何を確認しましたか？", cadastralStillNeeded: "何を追加確認しますか？", cadastralMapAria: "地籍参照エビデンス地図", cadastralLimitation: "認可された地籍ベクターを取得していないため、筆ポリゴン、交差、法定面積、地番を判定しません。", coordinateSource: "位置情報源", coordinateSources: { google_geocoding: "Google Geocoding", tgos_geocoding: "TGOS", mock: "デモ位置情報", provided_coordinates: "利用者入力座標", unknown: "不明" } });
...
Object.assign(terrainKo, { advanced: "고급 설정", radiusSummary: "현재 확인 반경", dataCompleteness: "데이터 완전성", checked: "확인됨", usable: "사용 가능", limitedCount: "제한적", unavailableCount: "사용 불가", priorityFollowUp: "우선 확인", actualEvidence: "실제 재해 근거", autoCheckAvailable: "자동 확인 가능", referenceExternal: "참고／외부 확인", temporarilyUnavailable: "일시적 사용 불가", matchedRange: "위험 범위에 해당", nearestDistance: "최단 거리: 약 {m} m", limitedSourceCaveat: "일부 공식 지도 데이터를 이번에 완전히 가져오지 못했습니다. 공식 지도 포털에서 다시 확인하세요.", progressTitle: "확인 진행", progressAccepted: "입력을 받았습니다", progressDispatched: "요청을 보냈습니다", progressWaiting: "데이터 출처 응답 대기 중", progressReceived: "응답을 받았습니다", progressRendering: "근거 정리 중", progressComplete: "결과가 표시되었습니다", cadastralTitle: "지적 참고 근거", cadastralSubtitle: "분석 좌표, 확인한 출처, 수동으로 확인할 항목을 보여 줍니다.", cadastralReferenceOnly: "지적 영상은 위치 참고 전용", cadastralPointOnly: "점 위치 참고 모드", cadastralLoading: "지적 참고 지도 불러오는 중", cadastralUnavailable: "지적 참고를 일시적으로 사용할 수 없음", cadastralNotConfigured: "승인된 지적 지도 서비스가 설정되지 않음", cadastralSource: "공식 출처", cadastralLastChecked: "마지막 확인", cadastralLegend: "지도 범례", cadastralMarkerLegend: "이번 분석 좌표", cadastralRadiusLegend: "분석 반경(필지 경계 아님)", cadastralManualVerification: "관할 지적 기관에서 등본, 지번, 경계 측량 자료 확인", cadastralWhere: "물건은 어디에 있나요?", cadastralChecked: "무엇을 확인했나요?", cadastralStillNeeded: "무엇을 더 확인해야 하나요?", cadastralMapAria: "지적 참고 근거 지도", cadastralLimitation: "승인된 지적 벡터를 확보하지 않았으므로 필지 폴리곤, 교차 여부, 법적 면적, 지번을 판단하지 않습니다.", coordinateSource: "위치 출처", coordinateSources: { google_geocoding: "Google Geocoding", tgos_geocoding: "TGOS", mock: "데모 위치 정보", provided_coordinates: "사용자 제공 좌표", unknown: "알 수 없음" } });
