...
export type ValuationDataStatus = { active_source: "real_price_sample" | "sqlite_index" | "postgres" | "mock_fallback"; is_demo_data: boolean; is_full_taiwan: boolean; data_composition?: "sample" | "official" | "mixed"; official_records_count?: number; sample_records_count?: number; official_period_min?: string | null; official_period_max?: string | null; official_coverage_note?: string; latest_import_status?: string | null; latest_import_scope?: string; latest_import_inserted_rows?: number; latest_import_skipped_duplicates?: number; coverage: { cities: string[]; districts: string[]; roads_count: number; records_count: number }; last_updated: string | null; update_frequency_note: string; source_note: string; user_message: string };
