...
APPROVED_ROUTES = {
    ...
    ("POST", "/v1/properties/{property_entity_id}/building-hypotheses"),
    ("POST", "/v1/parcel-building-relations"),
    ("POST", "/v1/cases"),
...
COMMAND_ROUTES = {
    ...
    "/v1/properties/{property_entity_id}/parcel-hypotheses",
    "/v1/properties/{property_entity_id}/building-hypotheses",
...
def test_frontend_session_and_dto_mutation_harness_passes() -> None:
    ...
    assert "VNext frontend hardening: 35 passed" in completed.stdout
